...
import org.slimroms.systemui.statusbar.SlimCommandQueue;
...
public abstract class SystemUISlimModule {
    ...
    @Binds
    abstract SlimCommandQueue provideSlimCommandQueue(SlimCommandQueue slimCommandQueue);

    @Provides
    @SysUISingleton
    static ActionsManager provideActionsManager(Context context) {
        return ActionsManager.getInstance(context);
    }
}
