...
import org.slimroms.systemui.theme.SlimThemeOverlayController
...
abstract class SystemUISlimCoreStartableModule {
    ...
    abstract fun bindThemeOverlayController(sysui: SlimThemeOverlayController): CoreStartable
