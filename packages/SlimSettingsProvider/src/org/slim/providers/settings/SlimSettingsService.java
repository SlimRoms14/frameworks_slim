...
final public class SlimSettingsService extends Binder {

    final SlimSettingsProvider mProvider;
    
    public SlimSettingsService(SlimSettingsProvider provider) {
        mProvider = provider;
    }
    ...
    final static class MyShellCommand extends ShellCommand {
        ...
        MyShellCommand(SlimSettingsProvider provider, boolean dumping) {
            mProvider = provider;
            mDumping = dumping;
        }
            ...
            do {
                if ("--user".equals(arg)) {
                    ...
                    if (!"system".equalsIgnoreCase(arg)
                            ...
                            && !"license".equalsIgnoreCase(arg)
                            && !"policy".equalsIgnoreCase(arg)
                            && !"rebrand".equalsIgnoreCase(arg)) {
        ...
        List<String> listForUser(IContentProvider provider, int userHandle, String table) {
            ...
            if ("system".equals(table)) callListCommand = SlimSettings.CALL_METHOD_LIST_SYSTEM;
            else if ("secure".equals(table)) callListCommand = SlimSettings.CALL_METHOD_LIST_SECURE;
            else if ("global".equals(table)) callListCommand = SlimSettings.CALL_METHOD_LIST_GLOBAL;
            else {
            ...
            try {
                ...
                Bundle result = provider.call(attributionSource, SlimSettings.AUTHORITY,
                        callListCommand, null, arg);
                lines.addAll(result.getStringArrayList(SlimSettingsProvider.RESULT_SETTINGS_LIST));
        ...
        String getForUser(IContentProvider provider, int userHandle,
            ...
            try {
                ...
                final AttributionSource attributionSource = new AttributionSource(
                        Binder.getCallingUid(), resolveCallingPackage(), /*attributionTag*/ null);
                Bundle b = provider.call(attributionSource, SlimSettings.AUTHORITY,
        ...
        void putForUser(IContentProvider provider, int userHandle, final String table,
            ...
            if ("system".equals(table)) {
                callPutCommand = SlimSettings.CALL_METHOD_PUT_SYSTEM;
                if (makeDefault) {
            ...
            try {
                ...
                final AttributionSource attributionSource = new AttributionSource(
                        Binder.getCallingUid(), resolveCallingPackage(), /*attributionTag*/ null);
                provider.call(attributionSource, SlimSettings.AUTHORITY,
        ...
        int deleteForUser(IContentProvider provider, int userHandle,
            ...
            if ("system".equals(table)) {
                callDeleteCommand = SlimSettings.CALL_METHOD_DELETE_SYSTEM;
            } else if ("secure".equals(table)) {
                callDeleteCommand = SlimSettings.CALL_METHOD_DELETE_SECURE;
            } else if ("global".equals(table)) {
                callDeleteCommand = SlimSettings.CALL_METHOD_DELETE_GLOBAL;
            } else {
            ...
            try {
                ...
                return result.getInt(SlimSettingsProvider.RESULT_ROWS_DELETED);
            } catch (RemoteException e) {
                throw new RuntimeException("Failed in IPC", e);
            }
        }
        ...
        static void dumpHelp(PrintWriter pw, boolean dumping) {
            if (dumping) {
                ...
                pw.println("      NAMESPACE is one of {system, secure, global, license, policy, rebrand}, case-insensitive");
            }
        }
    }
}