...
public class Action {
    ...
    public static void processActionWithOptions(Context context,
            ...
            ActionsManager actionsManager = ActionsManager.getInstance(context);
           ...
           if (windowManagerService == null) {
            ...
            try {
                isKeyguardSecure = windowManagerService.isKeyguardSecure(UserHandle.USER_CURRENT);
            } catch (RemoteException e) {
            }
    ...
    private static void startActivity(Context context, Intent intent,
            ActionsManager actionsManager, boolean isKeyguardShowing, PowerManager pm) {
        if (intent == null) {
            return;
        }
